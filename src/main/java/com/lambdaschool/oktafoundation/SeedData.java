    ...
    implements CommandLineRunner
{
                                   ...
                                   Exception
    {
        ...
        User llama001 = new User("llama001@maildrop.cc", "llama001@email.com", "llama1", "LLAMA_001", "(987)654-3210");
        llama001.getRoles()
            .add(new UserRoles(llama001,
                adminRole));
        llama001.getPrograms()
                .add(program1);
        llama001.getPrograms()
            .add(program2);
        llama001 = userService.save(llama001);

        program1 = programService.save(llama001.getUserid(), program1);
        program2 = programService.save(llama001.getUserid(), program2);
        ...
        course1 = courseService.save(course1.getProgram().getProgramid(), course1);
        course2 = courseService.save(course2.getProgram().getProgramid(), course2);
        course3 = courseService.save(course3.getProgram().getProgramid(), course3);
        ...
        module1 = moduleService.save(module1.getCourse().getCourseid(), module1);
        module2 = moduleService.save(module2.getCourse().getCourseid(), module2);
        module3 = moduleService.save(module3.getCourse().getCourseid(), module3);
        module4 = moduleService.save(module4.getCourse().getCourseid(), module4);

        User llama002 = new User(
        ...
        llama002.getRoles().add(new UserRoles(llama002, teacherRole));
    }
}